            ...
            <motion.div
              ...
              <div className='flex flex-col gap-3 items-center text-center'>
                ...
                <p className='dark:text-dark_black max-w-2xl'>
                  Descubre casos de estudio fascinantes, conoce a los pioneros que transformaron 
                  la industria y explora las herramientas que están definiendo el futuro del diseño digital.
                </p>
              </div>
