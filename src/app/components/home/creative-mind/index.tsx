          ...
          <div className='flex flex-col justify-center items-center gap-10 md:gap-20'>
            <div className='max-w-3xl text-center'>
              <motion.div {...bottomAnimation(-1)}>
                <h2>
                  Conoce a los pioneros que definieron el
                  <span className='instrument-font italic font-normal dark:text-white/70'>
                    {' '}diseño UX/UI
                  </span>
                </h2>
                <p className='text-dark_black/60 dark:text-white/60 mt-4'>
                  Estos visionarios establecieron los fundamentos teóricos y prácticos 
                  del diseño centrado en el usuario que aplicamos hoy en día.
                </p>
              </motion.div>
            </div>
