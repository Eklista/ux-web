            ...
            <div className='flex flex-col gap-8 text-center'>
              <div className='max-w-3xl mx-auto'>
                ...
                <p className='max-w-2xl mx-auto text-dark_black/60 dark:text-white/60 mt-4'>
                  Artículos, análisis y recursos sobre diseño de experiencia e interfaz de usuario. 
                  Desde principios fundamentales hasta las últimas tendencias de la industria.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className='py-11'>
          <div className='container'>
            <div className='flex flex-col gap-8'>
              <h2 className='text-2xl font-medium'>Artículos Destacados</h2>
