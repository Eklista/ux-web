            ...
            <div className='flex flex-col gap-8 text-center'>
              <div className='max-w-3xl mx-auto'>
                ...
                <p className='max-w-2xl mx-auto text-dark_black/60 dark:text-white/60 mt-4'>
                  Conoce a las figuras más influyentes que establecieron los fundamentos 
                  del diseño centrado en el usuario y transformaron la industria.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-8'>
            <h2 className='text-2xl font-medium text-center'>
              {selectedCategory === 'all' 
                ? `Todos los Pioneros (${filteredPioneers.length})` 
                      ...
                      <div className='relative overflow-hidden rounded-2xl'>
                        ...
                        <div className='absolute top-4 left-4'>
                          <span className='bg-white/90 text-dark_black px-3 py-1 rounded-full text-sm font-medium capitalize'>
                            {pioneer.category === 'researchers' ? 'Investigador' : 
                             pioneer.category === 'designers' ? 'Diseñador' :
                             pioneer.category === 'founders' ? 'Fundador' : 'Ingeniero'}
                          </span>
                        </div>
            ...
            {filteredPioneers.length === 0 && (
              <div className='text-center py-12'>
                <h3 className='text-xl font-medium mb-2'>No se encontraron pioneros</h3>
                <p className='text-dark_black/60 dark:text-white/60'>
